    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showDialogButton.setOnClickListener(v -> {
            new AlertDialog.Builder(this)
                    .setTitle("Информация")
                    .setMessage("Приложение созданно студентом группы ПО-10, Замойским А.С. Это приложение распознает жесты и преобразует их в математические выражения. Вы можете рисовать цифры и знаки операций, а затем вычислять результат. Для очистки используйте кнопку 'Очистить'.")
