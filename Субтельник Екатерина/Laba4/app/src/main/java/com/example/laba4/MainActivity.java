...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        downloadButton.setOnClickListener(v -> {
            ...
            if (idFile.isEmpty()) {
                Toast.makeText(this, "Enter file ID", Toast.LENGTH_SHORT).show();
                return;
            }

            idFile += ".pdf";
            if (fileExists(idFile)) {
                Toast.makeText(this, "File already loaded", Toast.LENGTH_SHORT).show();
            } else {
                new DownloadManager(this, progressBar).execute(idFile);
            }
        });
        ...
        viewButton.setOnClickListener(v -> {
            ...
            if (uri != null) {
                ...
                Toast.makeText(this, "File nit found", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private boolean fileExists(String fileName) {
        ...
        try (Cursor cursor = getContentResolver().query(uri, new String[]{MediaStore.MediaColumns._ID}, selection, selectionArgs, null)) {
            ...
            Log.e("FileCheck", "Error checking file", e);
            return false;
        }
    }
    ...
    private Uri getFileUri(String fileName) {
        ...
        try (Cursor cursor = getContentResolver().query(uri, projection, selection, selectionArgs, null)) {
            ...
            Log.e("FilePicker", "Error while searching for file", e);
        }
        return null;
    }
