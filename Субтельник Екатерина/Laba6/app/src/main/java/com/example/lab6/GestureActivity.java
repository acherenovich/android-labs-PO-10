...
public class GestureActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gestureOverlay.addOnGesturePerformedListener((overlay, gesture) -> {
            lastGesture = gesture;
            Toast.makeText(this, "Жест нарисован! Введите имя и сохраните.", Toast.LENGTH_SHORT).show();
        });
        ...
        saveButton.setOnClickListener(view -> {
            ...
            if (!gestureLibrary.load()) {
                Toast.makeText(this, "Ошибка обновления библиотеки жестов", Toast.LENGTH_SHORT).show();
            }
