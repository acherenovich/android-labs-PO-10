...
import androidx.core.app.ActivityCompat; // Импортируйте ActivityCompat
    ...
    public void onDestroy() {
        ...
        if (fusedLocationClient != null && locationCallback != null) {
            if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                ...
                Log.w("LocationService", "Нет разрешения на геолокацию для getLastLocation в onDestroy");
                // В случае отсутствия разрешения, можно пропустить getLastLocation или выполнить другие действия
            }
