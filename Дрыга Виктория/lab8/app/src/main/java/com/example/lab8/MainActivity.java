...
//
    ...
    private void addMarkerToMap(String name, double lat, double lon, long timestamp) {
        ...
        marker.setSnippet("Время: " + formattedDate + "<br>Координаты: " + lat + ", " + lon);
    ...
    private void showAddPointDialog() {
        ...
        builder.setTitle("Введите название точки");
        ...
        builder.setPositiveButton("Сохранить", (dialog, which) -> {
            ...
            if (!name.isEmpty()) {
                markPoint(name);  // передаем название в метод сохранения точки
            } else {
