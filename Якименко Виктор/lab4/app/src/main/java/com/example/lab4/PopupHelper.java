    ...
    public static void showPopup(Context context) {
        ...
        if (SettingsManager.shouldShowPopup(context)) {
            AlertDialog dialog = new AlertDialog.Builder(context)
                    .setTitle("Соглашение")
                    .setMessage("Загружая данные из приложения вы полностью несете отвественность перед правообладателями и соглашаетесь с нашей политикой конфиденциальности.")
                    .setView(layout)
