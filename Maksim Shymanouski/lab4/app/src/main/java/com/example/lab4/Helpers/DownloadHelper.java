...
public class DownloadHelper extends AsyncTask<String, Integer, Boolean> {
    ...
    protected Boolean doInBackground(String... id) {
        ...
        try {
            ...
            Log.e("FileDownloader", "An error while downloading: " + fileId, e);
            return false;
        }
    }
    ...
    private void savePdfFile(String fileId, byte[] pdfData) {
        ...
        if (uri != null) {
            try (OutputStream outputStream = context.getContentResolver().openOutputStream(uri)) {
                ...
                Log.e("SavePdf", "Error while file saving", e);
            }
        } else {
            Log.e("SavePdf", "Couldn't read URI for download file");
        }
    }
    ...
    protected void onPostExecute(Boolean success) {
        ...
        if (success) {
            Toast.makeText(context, "File was successfully downloaded!", Toast.LENGTH_SHORT).show();
        } else {
